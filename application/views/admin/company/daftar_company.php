<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    <h1 class="m-0 mb-1 text-dark">Company</h1>
                    <!-- </div> -->
                    <!-- <div class="col-md-9"> -->
                    <a href="<?= base_url('admin/company') ?>" class="btn btn-primary mb-n1">
                                    ...
                                    foreach ($all as $result) : ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="<?= base_url('admin/delete_company/') . $result['id'] ?>" class="btn btn-danger hapus">Hapus</a>
                                            </td>
                                        </tr>
                                    <?php endforeach ?>
                                </tbody>
