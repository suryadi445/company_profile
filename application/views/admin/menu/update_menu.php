                        ...
                        <form class="form-horizontal" action="<?= base_url('menu/proses_update') ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="custom-select" name="jenis_makanan" value="<?= $row['jenis_makanan'] ?>">
                                            <?php if ($row['jenis_makanan'] == 'makanan') { ?>
                                                <option value="makanan" selected <?php echo set_select('jenis_makanan', 'makanan'); ?>>Makanan</option>
                                            ...
                                            <?php } else { ?>
                                                ...
                                                <option value="minuman" selected <?php echo set_select('jenis_makanan', 'minuman'); ?>>Minuman</option>
                                            <?php } ?>
                                        </select>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="nama_menu" id="input_menu_makanan" value="<?= $row['nama_menu'] ?>">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="harga_menu" id="input_harga_makanan" value="<?= $row['harga_menu'] ?>">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <textarea class="form-control" rows="5" id="input_keterangan_makanan" name="keterangan_menu"><?= $row['keterangan'] ?></textarea>
